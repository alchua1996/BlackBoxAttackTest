...
from imagenet_blackBox_attack2 import main

### code to choose dataset
code = 1 ### 1 for MNIST; 2 for CIFAR-10; 3 for imagenet
...
alg_dic = {}
alg_dic['uncons'] = ['ZOSGD', 'ZOSCD', 'ZOsignSGD', 'ZOAdaMM', 'ZOAdaBound']
alg_dic['cons'] = ['ZOSMD', 'ZOPSGD', 'ZONES', 'ZOAdaMM', 'ZOAdaBound']

#alg_dic['uncons'] = ['ZOAdaMM', 'ZOAdaBound']
#alg_dic['cons'] = ['ZOAdaMM', 'ZOAdaBound']
